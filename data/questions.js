...
const QuestionData = {
  "J001": {
    ...
    "chapter": 1,
    "scene": "4月・帳簿の出発点",
    "story": "入社初日、先輩の水野と証憑を日付順に整え、会社の数字を帳簿へ移す最初の仕事に取りかかる。 「資本金・追加出資」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J002": {
    ...
    "chapter": 1,
    "scene": "4月・帳簿の出発点",
    "story": "入社初日、先輩の水野と証憑を日付順に整え、会社の数字を帳簿へ移す最初の仕事に取りかかる。 「現金・預金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J003": {
    ...
    "chapter": 1,
    "scene": "4月・帳簿の出発点",
    "story": "入社初日、先輩の水野と証憑を日付順に整え、会社の数字を帳簿へ移す最初の仕事に取りかかる。 「当座預金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J004": {
    ...
    "chapter": 2,
    "scene": "5月・仕入と販売",
    "story": "営業担当の高橋が新規受注を増やし、在庫補充の仕入と販売の双方が増え始める。取引ごとに代金と付随費用を切り分けて確認する。 「掛仕入」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J005": {
    ...
    "chapter": 2,
    "scene": "5月・仕入と販売",
    "story": "営業担当の高橋が新規受注を増やし、在庫補充の仕入と販売の双方が増え始める。取引ごとに代金と付随費用を切り分けて確認する。 「掛売上」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J006": {
    ...
    "chapter": 2,
    "scene": "5月・仕入と販売",
    "story": "営業担当の高橋が新規受注を増やし、在庫補充の仕入と販売の双方が増え始める。取引ごとに代金と付随費用を切り分けて確認する。 「仕入諸掛」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J007": {
    ...
    "chapter": 2,
    "scene": "5月・仕入と販売",
    "story": "営業担当の高橋が新規受注を増やし、在庫補充の仕入と販売の双方が増え始める。取引ごとに代金と付随費用を切り分けて確認する。 「売上諸掛」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J008": {
    ...
    "chapter": 2,
    "scene": "5月・仕入と販売",
    "story": "営業担当の高橋が新規受注を増やし、在庫補充の仕入と販売の双方が増え始める。取引ごとに代金と付随費用を切り分けて確認する。 「仕入返品」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J009": {
    ...
    "chapter": 2,
    "scene": "5月・仕入と販売",
    "story": "営業担当の高橋が新規受注を増やし、在庫補充の仕入と販売の双方が増え始める。取引ごとに代金と付随費用を切り分けて確認する。 「売上返品」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J010": {
    ...
    "chapter": 3,
    "scene": "6月・掛取引の管理",
    "story": "取引量の増加で入金日と支払日が複雑になった。売掛金・買掛金・電子記録債権債務を一覧にし、資金繰りの見通しを立てる。 「売掛金回収」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J011": {
    ...
    "chapter": 3,
    "scene": "6月・掛取引の管理",
    "story": "取引量の増加で入金日と支払日が複雑になった。売掛金・買掛金・電子記録債権債務を一覧にし、資金繰りの見通しを立てる。 「買掛金支払」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J012": {
    ...
    "chapter": 3,
    "scene": "6月・掛取引の管理",
    "story": "取引量の増加で入金日と支払日が複雑になった。売掛金・買掛金・電子記録債権債務を一覧にし、資金繰りの見通しを立てる。 「電子記録債務」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J013": {
    ...
    "chapter": 3,
    "scene": "6月・掛取引の管理",
    "story": "取引量の増加で入金日と支払日が複雑になった。売掛金・買掛金・電子記録債権債務を一覧にし、資金繰りの見通しを立てる。 「電子記録債権」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J014": {
    ...
    "chapter": 3,
    "scene": "6月・掛取引の管理",
    "story": "取引量の増加で入金日と支払日が複雑になった。売掛金・買掛金・電子記録債権債務を一覧にし、資金繰りの見通しを立てる。 「クレジット売掛金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J015": {
    ...
    "chapter": 3,
    "scene": "6月・掛取引の管理",
    "story": "取引量の増加で入金日と支払日が複雑になった。売掛金・買掛金・電子記録債権債務を一覧にし、資金繰りの見通しを立てる。 「前払金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J016": {
    ...
    "chapter": 3,
    "scene": "6月・掛取引の管理",
    "story": "取引量の増加で入金日と支払日が複雑になった。売掛金・買掛金・電子記録債権債務を一覧にし、資金繰りの見通しを立てる。 「前受金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J017": {
    ...
    "chapter": 4,
    "scene": "7月・現金の違和感",
    "story": "現金実査で差額が見つかった。総務担当の森と証憑をたどり、原因が分かるまで事実と推測を分けて処理する。 「現金過不足」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J018": {
    ...
    "chapter": 4,
    "scene": "7月・現金の違和感",
    "story": "現金実査で差額が見つかった。総務担当の森と証憑をたどり、原因が分かるまで事実と推測を分けて処理する。 「現金過不足判明」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J019": {
    ...
    "chapter": 4,
    "scene": "7月・現金の違和感",
    "story": "現金実査で差額が見つかった。総務担当の森と証憑をたどり、原因が分かるまで事実と推測を分けて処理する。 「小口現金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J020": {
    ...
    "chapter": 4,
    "scene": "7月・現金の違和感",
    "story": "現金実査で差額が見つかった。総務担当の森と証憑をたどり、原因が分かるまで事実と推測を分けて処理する。 「小口現金精算」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J021": {
    ...
    "chapter": 5,
    "scene": "8月・業務拡大",
    "story": "備品購入や出張が増え、商品以外の債権・債務も増えてきた。経理は支出の目的と回収義務を確認しながら処理する。 「固定資産購入」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J022": {
    ...
    "chapter": 5,
    "scene": "8月・業務拡大",
    "story": "備品購入や出張が増え、商品以外の債権・債務も増えてきた。経理は支出の目的と回収義務を確認しながら処理する。 「固定資産売却」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J023": {
    ...
    "chapter": 5,
    "scene": "8月・業務拡大",
    "story": "備品購入や出張が増え、商品以外の債権・債務も増えてきた。経理は支出の目的と回収義務を確認しながら処理する。 「仮払金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J024": {
    ...
    "chapter": 5,
    "scene": "8月・業務拡大",
    "story": "備品購入や出張が増え、商品以外の債権・債務も増えてきた。経理は支出の目的と回収義務を確認しながら処理する。 「仮払金精算」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J025": {
    ...
    "chapter": 5,
    "scene": "8月・業務拡大",
    "story": "備品購入や出張が増え、商品以外の債権・債務も増えてきた。経理は支出の目的と回収義務を確認しながら処理する。 「立替金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J026": {
    ...
    "chapter": 5,
    "scene": "8月・業務拡大",
    "story": "備品購入や出張が増え、商品以外の債権・債務も増えてきた。経理は支出の目的と回収義務を確認しながら処理する。 「借入金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J027": {
    ...
    "chapter": 5,
    "scene": "8月・業務拡大",
    "story": "備品購入や出張が増え、商品以外の債権・債務も増えてきた。経理は支出の目的と回収義務を確認しながら処理する。 「借入金返済」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J028": {
    ...
    "chapter": 6,
    "scene": "9月・給与と税金",
    "story": "従業員が増え、給与控除や社会保険、税金の納付が重なった。会社負担と従業員からの預り分を混同しないことが課題になる。 「給与」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J029": {
    ...
    "chapter": 6,
    "scene": "9月・給与と税金",
    "story": "従業員が増え、給与控除や社会保険、税金の納付が重なった。会社負担と従業員からの預り分を混同しないことが課題になる。 「預り金納付」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J030": {
    ...
    "chapter": 6,
    "scene": "9月・給与と税金",
    "story": "従業員が増え、給与控除や社会保険、税金の納付が重なった。会社負担と従業員からの預り分を混同しないことが課題になる。 「法定福利費」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J031": {
    ...
    "chapter": 6,
    "scene": "9月・給与と税金",
    "story": "従業員が増え、給与控除や社会保険、税金の納付が重なった。会社負担と従業員からの預り分を混同しないことが課題になる。 「租税公課」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J032": {
    ...
    "chapter": 6,
    "scene": "9月・給与と税金",
    "story": "従業員が増え、給与控除や社会保険、税金の納付が重なった。会社負担と従業員からの預り分を混同しないことが課題になる。 「収入印紙」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J033": {
    ...
    "chapter": 7,
    "scene": "10月・帳簿の照合",
    "story": "10月、補助簿と総勘定元帳を照合する。水野は前期の決算資料も取り出し、日常処理が決算へどうつながるかを確認させる。 「貸付金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J034": {
    ...
    "chapter": 7,
    "scene": "10月・帳簿の照合",
    "story": "10月、補助簿と総勘定元帳を照合する。水野は前期の決算資料も取り出し、日常処理が決算へどうつながるかを確認させる。 「利息受取」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J035": {
    ...
    "chapter": 7,
    "scene": "10月・帳簿の照合",
    "story": "10月、補助簿と総勘定元帳を照合する。水野は前期の決算資料も取り出し、日常処理が決算へどうつながるかを確認させる。 「貯蔵品」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J036": {
    ...
    "chapter": 7,
    "scene": "10月・帳簿の照合",
    "story": "10月、補助簿と総勘定元帳を照合する。水野は前期の決算資料も取り出し、日常処理が決算へどうつながるかを確認させる。 「受取商品券」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J037": {
    ...
    "chapter": 7,
    "scene": "10月・帳簿の照合",
    "story": "10月、補助簿と総勘定元帳を照合する。水野は前期の決算資料も取り出し、日常処理が決算へどうつながるかを確認させる。 「差入保証金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J038": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "11月、試算表のずれをきっかけに記帳内容を点検する。数字が合わないときは、責任追及より先に証憑と帳簿を照合する。 「訂正仕訳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J040": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "11月、試算表のずれをきっかけに記帳内容を点検する。数字が合わないときは、責任追及より先に証憑と帳簿を照合する。 「未記帳取引」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J041": {
    ...
    "chapter": 9,
    "scene": "12月・決算への準備",
    "story": "12月、3月決算に備えて前期の決算資料を使った予行演習を行う。現金の動きと収益・費用の期間帰属を切り分ける。 「前払費用」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J042": {
    ...
    "chapter": 9,
    "scene": "12月・決算への準備",
    "story": "12月、3月決算に備えて前期の決算資料を使った予行演習を行う。現金の動きと収益・費用の期間帰属を切り分ける。 「未払費用」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J043": {
    ...
    "chapter": 9,
    "scene": "12月・決算への準備",
    "story": "12月、3月決算に備えて前期の決算資料を使った予行演習を行う。現金の動きと収益・費用の期間帰属を切り分ける。 「前受収益」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J044": {
    ...
    "chapter": 9,
    "scene": "12月・決算への準備",
    "story": "12月、3月決算に備えて前期の決算資料を使った予行演習を行う。現金の動きと収益・費用の期間帰属を切り分ける。 「未収収益」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J045": {
    ...
    "chapter": 10,
    "scene": "1月・決算整理",
    "story": "1月、3月決算に備えて前期資料で決算整理を演習する。棚卸し、減価償却、貸倒れの見積りを根拠から確認する。 「貸倒引当金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J046": {
    ...
    "chapter": 10,
    "scene": "1月・決算整理",
    "story": "1月、3月決算に備えて前期資料で決算整理を演習する。棚卸し、減価償却、貸倒れの見積りを根拠から確認する。 「貸倒れ」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J047": {
    ...
    "chapter": 10,
    "scene": "1月・決算整理",
    "story": "1月、3月決算に備えて前期資料で決算整理を演習する。棚卸し、減価償却、貸倒れの見積りを根拠から確認する。 「減価償却」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J048": {
    ...
    "chapter": 10,
    "scene": "1月・決算整理",
    "story": "1月、3月決算に備えて前期資料で決算整理を演習する。棚卸し、減価償却、貸倒れの見積りを根拠から確認する。 「売上原価」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J049": {
    ...
    "chapter": 11,
    "scene": "2月・精算表",
    "story": "2月、前期の精算表を使い、決算整理仕訳が財務諸表へ反映される流れを確認する。 「消費税」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J050": {
    ...
    "chapter": 12,
    "scene": "3月・数字で会社を語る",
    "story": "3月、年度決算本番。主人公は一年かけて整えた帳簿を基に、社長へ会社の成果と財政状態を数字で説明する。 「当期純利益」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J051": {
    ...
    "chapter": 1,
    "scene": "復習編・水野先輩の確認",
    "story": "水野先輩が基礎取引の復習カードを渡した。以前と同じ結論を覚えるのではなく、資産・負債・純資産の増減からもう一度判断する。 「資本金・追加出資」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J052": {
    ...
    "chapter": 1,
    "scene": "復習編・水野先輩の確認",
    "story": "水野先輩が基礎取引の復習カードを渡した。以前と同じ結論を覚えるのではなく、資産・負債・純資産の増減からもう一度判断する。 「現金・預金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J053": {
    ...
    "chapter": 1,
    "scene": "復習編・水野先輩の確認",
    "story": "水野先輩が基礎取引の復習カードを渡した。以前と同じ結論を覚えるのではなく、資産・負債・純資産の増減からもう一度判断する。 「当座預金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J054": {
    ...
    "chapter": 2,
    "scene": "復習編・水野先輩の確認",
    "story": "水野先輩が仕入・販売の類似ケースを並べた。商品代金と付随費用、負担者と支払者を分けて読むことが復習の狙いだ。 「掛仕入」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J055": {
    ...
    "chapter": 2,
    "scene": "復習編・水野先輩の確認",
    "story": "水野先輩が仕入・販売の類似ケースを並べた。商品代金と付随費用、負担者と支払者を分けて読むことが復習の狙いだ。 「掛売上」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J056": {
    ...
    "chapter": 2,
    "scene": "復習編・水野先輩の確認",
    "story": "水野先輩が仕入・販売の類似ケースを並べた。商品代金と付随費用、負担者と支払者を分けて読むことが復習の狙いだ。 「仕入諸掛」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J057": {
    ...
    "chapter": 2,
    "scene": "復習編・水野先輩の確認",
    "story": "水野先輩が仕入・販売の類似ケースを並べた。商品代金と付随費用、負担者と支払者を分けて読むことが復習の狙いだ。 「売上諸掛」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J058": {
    ...
    "chapter": 2,
    "scene": "復習編・水野先輩の確認",
    "story": "水野先輩が仕入・販売の類似ケースを並べた。商品代金と付随費用、負担者と支払者を分けて読むことが復習の狙いだ。 「仕入返品」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J059": {
    ...
    "chapter": 2,
    "scene": "復習編・水野先輩の確認",
    "story": "水野先輩が仕入・販売の類似ケースを並べた。商品代金と付随費用、負担者と支払者を分けて読むことが復習の狙いだ。 「売上返品」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J060": {
    ...
    "chapter": 3,
    "scene": "復習編・水野先輩の確認",
    "story": "掛取引と決済の復習。債権・債務が別の決済手段へ変わっても、何が増え何が減るかを追跡する。 「売掛金回収」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J061": {
    ...
    "chapter": 3,
    "scene": "復習編・水野先輩の確認",
    "story": "掛取引と決済の復習。債権・債務が別の決済手段へ変わっても、何が増え何が減るかを追跡する。 「買掛金支払」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J062": {
    ...
    "chapter": 3,
    "scene": "復習編・水野先輩の確認",
    "story": "掛取引と決済の復習。債権・債務が別の決済手段へ変わっても、何が増え何が減るかを追跡する。 「電子記録債務」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J063": {
    ...
    "chapter": 3,
    "scene": "復習編・水野先輩の確認",
    "story": "掛取引と決済の復習。債権・債務が別の決済手段へ変わっても、何が増え何が減るかを追跡する。 「電子記録債権」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J064": {
    ...
    "chapter": 3,
    "scene": "復習編・水野先輩の確認",
    "story": "掛取引と決済の復習。債権・債務が別の決済手段へ変わっても、何が増え何が減るかを追跡する。 「クレジット売掛金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J065": {
    ...
    "chapter": 3,
    "scene": "復習編・水野先輩の確認",
    "story": "掛取引と決済の復習。債権・債務が別の決済手段へ変わっても、何が増え何が減るかを追跡する。 「前払金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J066": {
    ...
    "chapter": 3,
    "scene": "復習編・水野先輩の確認",
    "story": "掛取引と決済の復習。債権・債務が別の決済手段へ変わっても、何が増え何が減るかを追跡する。 「前受金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J067": {
    ...
    "chapter": 4,
    "scene": "復習編・水野先輩の確認",
    "story": "現金管理の復習。差額の発生、原因判明、小口現金の補給を、処理時点ごとに切り分ける。 「現金過不足」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J068": {
    ...
    "chapter": 4,
    "scene": "復習編・水野先輩の確認",
    "story": "現金管理の復習。差額の発生、原因判明、小口現金の補給を、処理時点ごとに切り分ける。 「現金過不足判明」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J069": {
    ...
    "chapter": 4,
    "scene": "復習編・水野先輩の確認",
    "story": "現金管理の復習。差額の発生、原因判明、小口現金の補給を、処理時点ごとに切り分ける。 「小口現金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J070": {
    ...
    "chapter": 4,
    "scene": "復習編・水野先輩の確認",
    "story": "現金管理の復習。差額の発生、原因判明、小口現金の補給を、処理時点ごとに切り分ける。 「小口現金精算」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "小口現金係から、交通費4,800円、通信費3,200円、消耗品費6,000円の報告を受け、直ちに同額の小切手を振り出して補給した。",
    "answer": {
      "debit": [
        {
  ...
  "J071": {
    ...
    "chapter": 5,
    "scene": "復習編・水野先輩の確認",
    "story": "商品以外の資産・債務の復習。支払ったという事実だけで費用と決めず、会社に残る権利や回収可能性を確認する。 「固定資産購入」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J072": {
    ...
    "chapter": 5,
    "scene": "復習編・水野先輩の確認",
    "story": "商品以外の資産・債務の復習。支払ったという事実だけで費用と決めず、会社に残る権利や回収可能性を確認する。 「固定資産売却」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J073": {
    ...
    "chapter": 5,
    "scene": "復習編・水野先輩の確認",
    "story": "商品以外の資産・債務の復習。支払ったという事実だけで費用と決めず、会社に残る権利や回収可能性を確認する。 「仮払金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J074": {
    ...
    "chapter": 5,
    "scene": "復習編・水野先輩の確認",
    "story": "商品以外の資産・債務の復習。支払ったという事実だけで費用と決めず、会社に残る権利や回収可能性を確認する。 「仮払金精算」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J075": {
    ...
    "chapter": 5,
    "scene": "復習編・水野先輩の確認",
    "story": "商品以外の資産・債務の復習。支払ったという事実だけで費用と決めず、会社に残る権利や回収可能性を確認する。 「立替金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J076": {
    ...
    "chapter": 5,
    "scene": "復習編・水野先輩の確認",
    "story": "商品以外の資産・債務の復習。支払ったという事実だけで費用と決めず、会社に残る権利や回収可能性を確認する。 「借入金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J077": {
    ...
    "chapter": 5,
    "scene": "復習編・水野先輩の確認",
    "story": "商品以外の資産・債務の復習。支払ったという事実だけで費用と決めず、会社に残る権利や回収可能性を確認する。 「借入金返済」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J078": {
    ...
    "chapter": 6,
    "scene": "復習編・水野先輩の確認",
    "story": "給与・税金の復習。会社負担、従業員からの預り、国等への納付という三者の関係を整理する。 「給与」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J079": {
    ...
    "chapter": 6,
    "scene": "復習編・水野先輩の確認",
    "story": "給与・税金の復習。会社負担、従業員からの預り、国等への納付という三者の関係を整理する。 「預り金納付」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J080": {
    ...
    "chapter": 6,
    "scene": "復習編・水野先輩の確認",
    "story": "給与・税金の復習。会社負担、従業員からの預り、国等への納付という三者の関係を整理する。 「法定福利費」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "社会保険料について、従業員預り分50,000円と会社負担分50,000円を普通預金から納付した。",
    "answer": {
      "debit": [
        {
  ...
  "J081": {
    ...
    "chapter": 6,
    "scene": "復習編・水野先輩の確認",
    "story": "給与・税金の復習。会社負担、従業員からの預り、国等への納付という三者の関係を整理する。 「租税公課」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "店舗に係る固定資産税48,000円を、納付書により現金で納付した。",
    "answer": {
      "debit": [
        {
  ...
  "J082": {
    ...
    "chapter": 6,
    "scene": "復習編・水野先輩の確認",
    "story": "給与・税金の復習。会社負担、従業員からの預り、国等への納付という三者の関係を整理する。 「収入印紙」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J083": {
    ...
    "chapter": 7,
    "scene": "復習編・水野先輩の確認",
    "story": "日常取引と補助簿の復習。過去の処理を別条件で確かめ、勘定科目の選択理由を言葉にする。 「貸付金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J084": {
    ...
    "chapter": 7,
    "scene": "復習編・水野先輩の確認",
    "story": "日常取引と補助簿の復習。過去の処理を別条件で確かめ、勘定科目の選択理由を言葉にする。 「利息受取」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J085": {
    ...
    "chapter": 7,
    "scene": "復習編・水野先輩の確認",
    "story": "日常取引と補助簿の復習。過去の処理を別条件で確かめ、勘定科目の選択理由を言葉にする。 「仮受金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J086": {
    ...
    "chapter": 7,
    "scene": "復習編・水野先輩の確認",
    "story": "日常取引と補助簿の復習。過去の処理を別条件で確かめ、勘定科目の選択理由を言葉にする。 「受取商品券」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J087": {
    ...
    "chapter": 7,
    "scene": "復習編・水野先輩の確認",
    "story": "日常取引と補助簿の復習。過去の処理を別条件で確かめ、勘定科目の選択理由を言葉にする。 「差入保証金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J088": {
    ...
    "chapter": 8,
    "scene": "復習編・水野先輩の確認",
    "story": "訂正の復習。誤り全体を消すのではなく、すでに正しい部分を残して差分だけ直す。 「訂正仕訳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J090": {
    ...
    "chapter": 8,
    "scene": "復習編・水野先輩の確認",
    "story": "訂正の復習。誤り全体を消すのではなく、すでに正しい部分を残して差分だけ直す。 「未記帳取引」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J091": {
    ...
    "chapter": 9,
    "scene": "復習編・水野先輩の確認",
    "story": "経過勘定の復習。支払日・受取日ではなく、当期に属する収益・費用かどうかを基準に判断する。 「前払費用」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J092": {
    ...
    "chapter": 9,
    "scene": "復習編・水野先輩の確認",
    "story": "経過勘定の復習。支払日・受取日ではなく、当期に属する収益・費用かどうかを基準に判断する。 「未払費用」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J093": {
    ...
    "chapter": 9,
    "scene": "復習編・水野先輩の確認",
    "story": "経過勘定の復習。支払日・受取日ではなく、当期に属する収益・費用かどうかを基準に判断する。 「前受収益」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J094": {
    ...
    "chapter": 9,
    "scene": "復習編・水野先輩の確認",
    "story": "経過勘定の復習。支払日・受取日ではなく、当期に属する収益・費用かどうかを基準に判断する。 「未収収益」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J095": {
    ...
    "chapter": 10,
    "scene": "復習編・水野先輩の確認",
    "story": "決算整理の復習。計算式だけでなく、なぜ期末に調整するのかを説明できるか確認する。 「貸倒引当金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J096": {
    ...
    "chapter": 10,
    "scene": "復習編・水野先輩の確認",
    "story": "決算整理の復習。計算式だけでなく、なぜ期末に調整するのかを説明できるか確認する。 「貸倒れ」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J097": {
    ...
    "chapter": 10,
    "scene": "復習編・水野先輩の確認",
    "story": "決算整理の復習。計算式だけでなく、なぜ期末に調整するのかを説明できるか確認する。 「減価償却」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J098": {
    ...
    "chapter": 10,
    "scene": "復習編・水野先輩の確認",
    "story": "決算整理の復習。計算式だけでなく、なぜ期末に調整するのかを説明できるか確認する。 「売上原価」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J099": {
    ...
    "chapter": 11,
    "scene": "復習編・水野先輩の確認",
    "story": "消費税の決算処理を復習し、仮払・仮受の相殺と未払額の意味を確認する。 「消費税」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J100": {
    ...
    "chapter": 12,
    "scene": "復習編・水野先輩の確認",
    "story": "決算振替の復習。利益がどのように純資産へつながるかを確認する。 「当期純利益」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J101": {
    ...
    "chapter": 1,
    "scene": "応用編・実務判断",
    "story": "応用ケース。別の取引条件でも、勘定科目の属性から仕訳を組み立てられるかを確認する。 「資本金・追加出資」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J102": {
    ...
    "chapter": 1,
    "scene": "応用編・実務判断",
    "story": "応用ケース。別の取引条件でも、勘定科目の属性から仕訳を組み立てられるかを確認する。 「現金・預金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J103": {
    ...
    "chapter": 1,
    "scene": "応用編・実務判断",
    "story": "応用ケース。別の取引条件でも、勘定科目の属性から仕訳を組み立てられるかを確認する。 「当座預金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J104": {
    ...
    "chapter": 2,
    "scene": "応用編・実務判断",
    "story": "応用ケース。商品売買の条件を読み、商品代金・返品・諸掛りを一つずつ切り分ける。 「掛仕入」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J105": {
    ...
    "chapter": 2,
    "scene": "応用編・実務判断",
    "story": "応用ケース。商品売買の条件を読み、商品代金・返品・諸掛りを一つずつ切り分ける。 「掛売上」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J106": {
    ...
    "chapter": 2,
    "scene": "応用編・実務判断",
    "story": "応用ケース。商品売買の条件を読み、商品代金・返品・諸掛りを一つずつ切り分ける。 「仕入諸掛」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J107": {
    ...
    "chapter": 2,
    "scene": "応用編・実務判断",
    "story": "応用ケース。商品売買の条件を読み、商品代金・返品・諸掛りを一つずつ切り分ける。 「売上諸掛」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J108": {
    ...
    "chapter": 2,
    "scene": "応用編・実務判断",
    "story": "応用ケース。商品売買の条件を読み、商品代金・返品・諸掛りを一つずつ切り分ける。 「仕入返品」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J109": {
    ...
    "chapter": 2,
    "scene": "応用編・実務判断",
    "story": "応用ケース。商品売買の条件を読み、商品代金・返品・諸掛りを一つずつ切り分ける。 「売上返品」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J110": {
    ...
    "chapter": 3,
    "scene": "応用編・実務判断",
    "story": "応用ケース。複数の決済手段が登場しても、債権・債務の変化を追って判断する。 「売掛金回収」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J111": {
    ...
    "chapter": 3,
    "scene": "応用編・実務判断",
    "story": "応用ケース。複数の決済手段が登場しても、債権・債務の変化を追って判断する。 「買掛金支払」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J112": {
    ...
    "chapter": 3,
    "scene": "応用編・実務判断",
    "story": "応用ケース。複数の決済手段が登場しても、債権・債務の変化を追って判断する。 「電子記録債務」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J113": {
    ...
    "chapter": 3,
    "scene": "応用編・実務判断",
    "story": "応用ケース。複数の決済手段が登場しても、債権・債務の変化を追って判断する。 「電子記録債権」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J114": {
    ...
    "chapter": 3,
    "scene": "応用編・実務判断",
    "story": "応用ケース。複数の決済手段が登場しても、債権・債務の変化を追って判断する。 「クレジット売掛金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J115": {
    ...
    "chapter": 3,
    "scene": "応用編・実務判断",
    "story": "応用ケース。複数の決済手段が登場しても、債権・債務の変化を追って判断する。 「前払金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J116": {
    ...
    "chapter": 3,
    "scene": "応用編・実務判断",
    "story": "応用ケース。複数の決済手段が登場しても、債権・債務の変化を追って判断する。 「前受金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J117": {
    ...
    "chapter": 4,
    "scene": "応用編・実務判断",
    "story": "応用ケース。現金管理の証憑を読み、仮処理と確定処理を混同しない。 「現金過不足」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J118": {
    ...
    "chapter": 4,
    "scene": "応用編・実務判断",
    "story": "応用ケース。現金管理の証憑を読み、仮処理と確定処理を混同しない。 「現金過不足判明」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J119": {
    ...
    "chapter": 4,
    "scene": "応用編・実務判断",
    "story": "応用ケース。現金管理の証憑を読み、仮処理と確定処理を混同しない。 「小口現金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J120": {
    ...
    "chapter": 4,
    "scene": "応用編・実務判断",
    "story": "応用ケース。現金管理の証憑を読み、仮処理と確定処理を混同しない。 「小口現金精算」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J121": {
    ...
    "chapter": 5,
    "scene": "応用編・実務判断",
    "story": "応用ケース。固定資産、仮払金、立替金、借入金を、支出の目的と回収・返済義務から見分ける。 「固定資産購入」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J122": {
    ...
    "chapter": 5,
    "scene": "応用編・実務判断",
    "story": "応用ケース。固定資産、仮払金、立替金、借入金を、支出の目的と回収・返済義務から見分ける。 「固定資産売却」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J123": {
    ...
    "chapter": 5,
    "scene": "応用編・実務判断",
    "story": "応用ケース。固定資産、仮払金、立替金、借入金を、支出の目的と回収・返済義務から見分ける。 「仮払金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J124": {
    ...
    "chapter": 5,
    "scene": "応用編・実務判断",
    "story": "応用ケース。固定資産、仮払金、立替金、借入金を、支出の目的と回収・返済義務から見分ける。 「仮払金精算」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J125": {
    ...
    "chapter": 5,
    "scene": "応用編・実務判断",
    "story": "応用ケース。固定資産、仮払金、立替金、借入金を、支出の目的と回収・返済義務から見分ける。 「立替金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J126": {
    ...
    "chapter": 5,
    "scene": "応用編・実務判断",
    "story": "応用ケース。固定資産、仮払金、立替金、借入金を、支出の目的と回収・返済義務から見分ける。 「借入金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J127": {
    ...
    "chapter": 5,
    "scene": "応用編・実務判断",
    "story": "応用ケース。固定資産、仮払金、立替金、借入金を、支出の目的と回収・返済義務から見分ける。 「借入金返済」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J128": {
    ...
    "chapter": 6,
    "scene": "応用編・実務判断",
    "story": "応用ケース。給与・税金を、費用・預り金・納付の三つの視点から整理する。 「給与」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J129": {
    ...
    "chapter": 6,
    "scene": "応用編・実務判断",
    "story": "応用ケース。給与・税金を、費用・預り金・納付の三つの視点から整理する。 「預り金納付」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J130": {
    ...
    "chapter": 6,
    "scene": "応用編・実務判断",
    "story": "応用ケース。給与・税金を、費用・預り金・納付の三つの視点から整理する。 「法定福利費」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J131": {
    ...
    "chapter": 6,
    "scene": "応用編・実務判断",
    "story": "応用ケース。給与・税金を、費用・預り金・納付の三つの視点から整理する。 「水道光熱費」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J132": {
    ...
    "chapter": 6,
    "scene": "応用編・実務判断",
    "story": "応用ケース。給与・税金を、費用・預り金・納付の三つの視点から整理する。 「収入印紙」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J133": {
    ...
    "chapter": 7,
    "scene": "応用編・実務判断",
    "story": "応用ケース。日常取引に加えて法人税等も扱い、勘定科目の性質から判断する。 「貸付金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J134": {
    ...
    "chapter": 7,
    "scene": "応用編・実務判断",
    "story": "応用ケース。日常取引に加えて法人税等も扱い、勘定科目の性質から判断する。 「償却債権取立益」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J135": {
    ...
    "chapter": 7,
    "scene": "応用編・実務判断",
    "story": "応用ケース。日常取引に加えて法人税等も扱い、勘定科目の性質から判断する。 「法人税等」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J136": {
    ...
    "chapter": 7,
    "scene": "応用編・実務判断",
    "story": "応用ケース。日常取引に加えて法人税等も扱い、勘定科目の性質から判断する。 「受取商品券」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J137": {
    ...
    "chapter": 7,
    "scene": "応用編・実務判断",
    "story": "応用ケース。日常取引に加えて法人税等も扱い、勘定科目の性質から判断する。 「未収入金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J138": {
    ...
    "chapter": 8,
    "scene": "応用編・実務判断",
    "story": "応用ケース。訂正仕訳では、正しい部分を残して誤りだけを反転・追加する。 「訂正仕訳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J140": {
    ...
    "chapter": 8,
    "scene": "応用編・実務判断",
    "story": "応用ケース。訂正仕訳では、正しい部分を残して誤りだけを反転・追加する。 「未記帳取引」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J141": {
    ...
    "chapter": 9,
    "scene": "応用編・実務判断",
    "story": "応用ケース。経過勘定を、現金の動きではなく発生期間から判断する。 「前払費用」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J142": {
    ...
    "chapter": 9,
    "scene": "応用編・実務判断",
    "story": "応用ケース。経過勘定を、現金の動きではなく発生期間から判断する。 「未払費用」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J143": {
    ...
    "chapter": 9,
    "scene": "応用編・実務判断",
    "story": "応用ケース。経過勘定を、現金の動きではなく発生期間から判断する。 「前受収益」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J144": {
    ...
    "chapter": 9,
    "scene": "応用編・実務判断",
    "story": "応用ケース。経過勘定を、現金の動きではなく発生期間から判断する。 「未収収益」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J145": {
    ...
    "chapter": 10,
    "scene": "応用編・実務判断",
    "story": "応用ケース。決算整理事項を複数の根拠から読み取り、期末残高へつなげる。 「貸倒引当金」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J146": {
    ...
    "chapter": 10,
    "scene": "応用編・実務判断",
    "story": "応用ケース。決算整理事項を複数の根拠から読み取り、期末残高へつなげる。 「貸倒れ」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J147": {
    ...
    "chapter": 10,
    "scene": "応用編・実務判断",
    "story": "応用ケース。決算整理事項を複数の根拠から読み取り、期末残高へつなげる。 「当座借越」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J148": {
    ...
    "chapter": 10,
    "scene": "応用編・実務判断",
    "story": "応用ケース。決算整理事項を複数の根拠から読み取り、期末残高へつなげる。 「受取手形」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J149": {
    ...
    "chapter": 11,
    "scene": "応用編・実務判断",
    "story": "応用ケース。消費税の仮勘定を相殺し、決算時点の納付義務を判断する。 「支払手形」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "J150": {
    ...
    "chapter": 12,
    "scene": "応用編・実務判断",
    "story": "応用ケース。損益勘定から純資産への振替を、決算の締めとして確認する。 「手形の取立と支払」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "L001": {
    ...
    "chapter": 7,
    "scene": "10月・帳簿の照合",
    "story": "10月、元帳の残高を自分で追えるようになった。水野は「転記したら残高まで確認する」と繰り返す。 「総勘定元帳（現金）」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "L002": {
    ...
    "chapter": 7,
    "scene": "10月・帳簿の照合",
    "story": "10月、元帳の残高を自分で追えるようになった。水野は「転記したら残高まで確認する」と繰り返す。 「売掛金元帳（みなと商店）」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "L003": {
    ...
    "chapter": 7,
    "scene": "10月・帳簿の照合",
    "story": "10月、元帳の残高を自分で追えるようになった。水野は「転記したら残高まで確認する」と繰り返す。 「買掛金元帳（若葉物産）」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "L004": {
    ...
    "chapter": 7,
    "scene": "10月・帳簿の照合",
    "story": "10月、元帳の残高を自分で追えるようになった。水野は「転記したら残高まで確認する」と繰り返す。 「商品有高帳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "L015": {
    ...
    "explanation": "請求書から取得日4月1日と取得原価475,000円を確認し、償却条件から残存価額0円、耐用年数5年、定額法、3月31日決算を確認します。会計期間は4月1日から翌年3月31日までなので使用月数は12か月です。1年分の減価償却費は475,000円÷5年＝95,000円、当期減価償却費は95,000円、期末帳簿価額は475,000円－95,000円＝380,000円です。"
  },
  "L016": {
    "id": "L016",
    "type": "ledger",
  ...
  "L021": {
    ...
    "chapter": 7,
    "scene": "10月・帳簿の照合",
    "story": "10月後半、補助簿と総勘定元帳の照合を任される。残高の変化を取引の原因までたどる練習を重ねる。 「総勘定元帳（現金）」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "水野先輩と現金元帳を照合する。取引ごとの増減を反映し、連続する残高を求めなさい。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L022": {
    ...
    "chapter": 7,
    "scene": "10月・帳簿の照合",
    "story": "10月後半、補助簿と総勘定元帳の照合を任される。残高の変化を取引の原因までたどる練習を重ねる。 「売掛金元帳（みなと商店）」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "得意先別の売掛金元帳を確認する。掛売上で増加、回収で減少することを踏まえ、残高欄を完成させなさい。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L023": {
    ...
    "chapter": 7,
    "scene": "10月・帳簿の照合",
    "story": "10月後半、補助簿と総勘定元帳の照合を任される。残高の変化を取引の原因までたどる練習を重ねる。 「買掛金元帳（若葉物産）」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "買掛金元帳の取引後残高を求めなさい。負債は貸方で増え、借方で減る点に注意すること。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L024": {
    ...
    "chapter": 7,
    "scene": "10月・帳簿の照合",
    "story": "10月後半、補助簿と総勘定元帳の照合を任される。残高の変化を取引の原因までたどる練習を重ねる。 「商品有高帳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "商品有高帳を確認する。数量だけでなく単価の層を追い、先入先出法による払出額と残高を求めなさい。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L030": {
    ...
    "table": {
      ...
      "inputMetadata": {
        "annualDepreciation":{"label":"1年分の減価償却費","semanticType":"amount"},
        "months":{"label":"使用月数","semanticType":"months"},
        "currentDepreciation":{"label":"当期減価償却費","semanticType":"amount"},
        "closingAccumulated":{"label":"期末減価償却累計額","semanticType":"amount"},
        "closingBookValue":{"label":"期末帳簿価額","semanticType":"amount"}
      }
    },
    ...
    "explanation":"会計期間は4月1日から翌年3月31日までで、備品Aは12月1日取得、取得原価360,000円、残存価額0円、耐用年数5年、定額法です。1年分の減価償却費は360,000円÷5年＝72,000円です。取得月を含めて12月・1月・2月・3月の4か月なので、当期減価償却費は72,000円×4÷12＝24,000円です。初年度のため期末減価償却累計額も24,000円、期末帳簿価額は360,000円－24,000円＝336,000円です。12月から3月までを3か月と数えず、取得月の12月を含めて4か月と数えます。"
  },
  "L031": {
    "id": "L031",
    "type": "ledger",
  ...
  "L034": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "10月後半、補助簿と総勘定元帳の照合を任される。残高の変化を取引の原因までたどる練習を重ねる。 「仕訳帳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "商品有高帳を先入先出法で完成させなさい。払出単価、払出額、期末残高を順に求めること。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L035": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "10月後半、補助簿と総勘定元帳の照合を任される。残高の変化を取引の原因までたどる練習を重ねる。 「受取手形記入帳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "L036": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "10月後半、補助簿と総勘定元帳の照合を任される。残高の変化を取引の原因までたどる練習を重ねる。 「支払手形記入帳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "水野先輩と現金元帳を照合する。取引ごとの増減を反映し、連続する残高を求めなさい。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L037": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "10月後半、補助簿と総勘定元帳の照合を任される。残高の変化を取引の原因までたどる練習を重ねる。 「総勘定元帳（売掛金）」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "得意先別の売掛金元帳を確認する。掛売上で増加、回収で減少することを踏まえ、残高欄を完成させなさい。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L038": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "10月後半、補助簿と総勘定元帳の照合を任される。残高の変化を取引の原因までたどる練習を重ねる。 「総勘定元帳（買掛金）」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "買掛金元帳の取引後残高を求めなさい。負債は貸方で増え、借方で減る点に注意すること。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L039": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "10月後半、補助簿と総勘定元帳の照合を任される。残高の変化を取引の原因までたどる練習を重ねる。 「支払利息勘定（複数年度・再振替）」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "商品有高帳を確認する。数量だけでなく単価の層を追い、先入先出法による払出額と残高を求めなさい。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L041": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "11月、月次締めの点検で元帳を再確認する。数字だけでなく、増減の理由を説明できることが求められる。 「仕訳帳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "入出金を現金元帳へ転記した。各取引後の残高を計算し、残高欄を完成させなさい。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L042": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "11月、月次締めの点検で元帳を再確認する。数字だけでなく、増減の理由を説明できることが求められる。 「受取手形記入帳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "得意先別残高を照合する。売掛金の増減を反映し、各時点の残高を入力しなさい。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L043": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "11月、月次締めの点検で元帳を再確認する。数字だけでなく、増減の理由を説明できることが求められる。 「支払手形記入帳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "仕入先別の買掛金元帳を確認する。掛仕入で増加、支払で減少することを踏まえ、残高欄を完成させなさい。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L044": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "11月、月次締めの点検で元帳を再確認する。数字だけでなく、増減の理由を説明できることが求められる。 「現金出納帳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "先入先出法では古い仕入単価から払い出します。表の払出額と残高を完成させなさい。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L045": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "11月、月次締めの点検で元帳を再確認する。数字だけでなく、増減の理由を説明できることが求められる。 「当座預金出納帳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "L046": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "11月、月次締めの点検で元帳を再確認する。数字だけでなく、増減の理由を説明できることが求められる。 「小口現金出納帳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "現金元帳の残高欄を完成させなさい。現金は資産なので、借方記入で増加し、貸方記入で減少します。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L047": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "11月、月次締めの点検で元帳を再確認する。数字だけでなく、増減の理由を説明できることが求められる。 「仕入帳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "売掛金元帳の取引後残高を求めなさい。得意先への掛販売と回収を混同しないこと。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L048": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "11月、月次締めの点検で元帳を再確認する。数字だけでなく、増減の理由を説明できることが求められる。 「売上帳」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "仕入先別残高を照合する。掛仕入と支払を反映し、各時点の残高を入力しなさい。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L049": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "11月、月次締めの点検で元帳を再確認する。数字だけでなく、増減の理由を説明できることが求められる。 「商品有高帳・移動平均法」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "商品有高帳を先入先出法で完成させなさい。払出単価、払出額、期末残高を順に求めること。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "L050": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "11月、月次締めの点検で元帳を再確認する。数字だけでなく、増減の理由を説明できることが求められる。 「伝票（3伝票制）」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "固定資産台帳を更新する。取得原価・耐用年数・期首減価償却累計額から、当期償却額と期末帳簿価額を求めなさい。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "T001": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "11月、月次締めの残高試算表を使って、勘定の性質と貸借一致の意味を確認する。 「残高試算表」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "E001": {
    ...
    "chapter": 8,
    "scene": "11月・残高の点検",
    "story": "11月、月次締めの照合で記帳ミスを発見した。水野は「全部をやり直すのではなく、正しい部分を残して差分だけ直す」と教える。 「記帳訂正」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "D001": {
    ...
    "chapter": 10,
    "scene": "1月・決算整理",
    "story": "1月、水野先輩が前期資料を使い、3月決算に向けた予行演習を行う。期間配分と固定資産の評価を同じ表で混同しないことが課題だ。 「8桁精算表」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "D002": {
    ...
    "chapter": 10,
    "scene": "1月・決算整理",
    "story": "1月、水野先輩が前期資料を使い、3月決算に向けた予行演習を行う。期間配分と固定資産の評価を同じ表で混同しないことが課題だ。 「決算整理・計算問題」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "D019": {
    ...
    "chapter": 10,
    "scene": "1月・決算整理",
    "story": "1月、水野先輩が前期資料を使い、3月決算に向けた予行演習を行う。期間配分と固定資産の評価を同じ表で混同しないことが課題だ。 「決算整理後残高試算表」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "D020": {
    ...
    "chapter": 10,
    "scene": "1月・決算整理",
    "story": "1月、水野先輩が前期資料を使い、3月決算に向けた予行演習を行う。期間配分と固定資産の評価を同じ表で混同しないことが課題だ。 「帳簿締切」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "F001": {
    ...
    "chapter": 12,
    "scene": "3月・数字で会社を語る",
    "story": "年度決算を完成させ、社長へ会社の成果と財政状態を報告する。 「損益計算書」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "F002": {
    ...
    "chapter": 12,
    "scene": "3月・数字で会社を語る",
    "story": "年度決算を完成させ、社長へ会社の成果と財政状態を報告する。 「貸借対照表」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "年度末の貸借対照表を作成している。表に示した項目以外の資産・負債・純資産はないものとする。空欄を補い、資産合計と負債・純資産合計が一致することを確認しなさい。",
    "materials": [],
    "table": {
      "columns": [
  ...
  "C001": {
    ...
    "chapter": 12,
    "scene": "3月・数字で会社を語る",
    "story": "3月、社長への月次・年度報告を前に、主人公は「現金」と「利益」が同じものではないことを複数資料から説明する。 「統合決算A（棚卸・貸倒・月割）」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
  ...
  "C002": {
    ...
    "chapter": 12,
    "scene": "3月・数字で会社を語る",
    "story": "3月、社長への月次・年度報告を前に、主人公は「現金」と「利益」が同じものではないことを複数資料から説明する。 「統合決算B（訂正・消費税・現金過不足）」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "社長から「3月末の現金はいくら残り、3月の利益はいくらか」と尋ねられた。現金の増減と収益・費用の発生を分けて考え、二つの金額を答えなさい。",
    "materials": [
      {
        "date": "3月1日",
  ...
  "C003": {
    ...
    "chapter": 12,
    "scene": "3月・数字で会社を語る",
    "story": "3月、社長への月次・年度報告を前に、主人公は「現金」と「利益」が同じものではないことを複数資料から説明する。 「統合決算C（経過勘定・固定資産・貸倒）」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "社長から「3月末の現金はいくら残り、3月の利益はいくらか」と尋ねられた。現金の増減と収益・費用の発生を分けて考え、二つの金額を答えなさい。",
    "materials": [
      {
        "date": "3月1日",
  ...
  "C004": {
    ...
    "chapter": 12,
    "scene": "3月・数字で会社を語る",
    "story": "3月、社長への月次・年度報告を前に、主人公は「現金」と「利益」が同じものではないことを複数資料から説明する。 「複数資料読み取り」に関する証憑と帳簿を突き合わせ、判断の根拠を水野先輩へ報告する。",
    "question": "社長から「3月末の現金はいくら残り、3月の利益はいくらか」と尋ねられた。現金の増減と収益・費用の発生を分けて考え、二つの金額を答えなさい。",
    "materials": [
      {
        "date": "3月1日",
...
QuestionData.L041 = practicalLedger('L041','仕訳帳','取引資料を日付順に仕訳帳へ記帳しなさい。元丁は現金101、売掛金113、売上401、通信費521とする。',
  [{日付:'4/3',取引:'商品90,000円を掛販売'},{日付:'4/8',取引:'通信費12,000円を現金払い'}],
  ['第1取引日','4/3 借方科目','4/3 借方元丁','4/3 借方金額','4/3 貸方科目','4/3 貸方元丁','4/3 貸方金額','第2取引日','4/8 借方科目','4/8 借方元丁','4/8 借方金額','4/8 貸方科目','4/8 貸方元丁','4/8 貸方金額'],
  {date1:'4/3',d1Account:'売掛金',d1Ref:113,d1Amount:90000,c1Account:'売上',c1Ref:401,c1Amount:90000,date2:'4/8',d2Account:'通信費',d2Ref:521,d2Amount:12000,c2Account:'現金',c2Ref:101,c2Amount:12000},
  '仕訳帳は日付、摘要欄の勘定科目、元丁、借方・貸方金額を日付順に記入します。4月3日は売掛金／売上90,000円、4月8日は通信費／現金12,000円です。');
...
QuestionData.L034=examLedgerVariant('L034','仕訳帳','複合仕訳','二つの証憑を日付順に仕訳帳へ記帳しなさい。元丁は現金101、売掛金113、売上401、通信費521とする。',[{日付:'8/2',証憑:'売上票',内容:'商品90,000円を掛販売'},{日付:'8/6',証憑:'領収証',内容:'通信費12,000円を現金払い'}],{date1:'8/2',d1Account:'売掛金',d1Ref:113,d1Amount:90000,c1Account:'売上',c1Ref:401,c1Amount:90000,date2:'8/6',d2Account:'通信費',d2Ref:521,d2Amount:12000,c2Account:'現金',c2Ref:101,c2Amount:12000},['第1取引日','8/2 借方科目','8/2 借方元丁','8/2 借方金額','8/2 貸方科目','8/2 貸方元丁','8/2 貸方金額','第2取引日','8/6 借方科目','8/6 借方元丁','8/6 借方金額','8/6 貸方科目','8/6 貸方元丁','8/6 貸方金額'],'仕訳帳は日付、摘要欄の勘定科目、元丁、借方・貸方金額を日付順に記入します。8月2日は売掛金／売上90,000円、8月6日は通信費／現金12,000円です。');
...
function independentlyDerivedTableCells(item) {
  ...
  if (item?.type === 'ledger' && item.materials?.length && item.table?.inputCells?.includes('d1Account')) {
    ...
    return {date1:item.materials[0].日付,d1Account:entries[0].d,d1Ref:folios[entries[0].d],d1Amount:entries[0].amount,c1Account:entries[0].c,c1Ref:folios[entries[0].c],c1Amount:entries[0].amount,date2:item.materials[1].日付,d2Account:entries[1].d,d2Ref:folios[entries[1].d],d2Amount:entries[1].amount,c2Account:entries[1].c,c2Ref:folios[entries[1].c],c2Amount:entries[1].amount};
  }
...
function independentlyDerivedJournal(item) {
  ...
  if (/当座借越契約.+期中.+仕入代金.+小切手/.test(text)){const purchase=amount(1);return entry([row('仕入',purchase)],[row('当座預金',purchase)]);}
...
function validateQuestionData(questionData = QuestionData) {
  ...
  for (let n = 1; n <= 20; n += 1) {
    ...
    if (text.includes('間接法') && !String(item.explanation || '').includes('備品勘定そのものを減額しません')) {
...
const ChapterDrama = Object.freeze({
  1:{theme:'消えた創業伝票',place:'入社初日の経理室',requester:'水野先輩',problem:'創業時の帳簿に、証憑と一致しない空欄が見つかりました',goal:'会社の最初の残高を復元する',result:'創業時の残高',stakes:'創業時の残高を誤れば、この先の数字はすべて崩れる'},
  2:{theme:'営業部の未精算',place:'営業会議後の経理室',requester:'営業担当の高橋',problem:'入金予定と未精算の立替金が混ざり、回収すべき相手が分からなくなっています',goal:'売上と立替金の回収先を明らかにする',result:'回収先別の残高',stakes:'回収先を特定できなければ、黒字のまま資金が尽きる'},
  3:{theme:'総務倉庫の食い違い',place:'総務倉庫の棚卸し現場',requester:'総務担当者',problem:'倉庫にある備品と台帳の記録が一致しません',goal:'備品と経費の記録を実物と一致させる',result:'備品と経費の正しい残高',stakes:'帳簿にある資産が、倉庫には見当たらない'},
  4:{theme:'資金繰り警報',place:'週末の資金繰り会議',requester:'社長',problem:'週明けの支払額に対して、使える資金がいくらあるのか判断できません',goal:'債権と債務の金額・期限を整理する',result:'週明けに必要な資金額',stakes:'週明けの支払いまで、残された時間は少ない'},
  5:{theme:'給与日の混乱',place:'給与振込前日の経理室',requester:'人事担当者',problem:'給与、会社負担分、従業員からの預り分が集計表で混在しています',goal:'従業員ごとの支給額と会社の負担額を確定する',result:'給与振込と納付に必要な金額',stakes:'一人分でも誤れば、社員の生活と会社の信用を傷つける'},
  6:{theme:'証憑監査',place:'監査資料を広げた会議室',requester:'監査担当者',problem:'帳簿の一部について、証憑との対応を説明できない状態です',goal:'誤記と不足資料を特定する',result:'証憑で説明できる帳簿残高',stakes:'監査担当は、説明できない一円も見逃さない'},
  7:{theme:'月次締めの壁',place:'月末の経理室',requester:'水野先輩',problem:'伝票と補助簿への転記が終わらず、月次の残高を確定できません',goal:'証憑から各帳簿への転記を完了する',result:'月次報告に使う帳簿残高',stakes:'締切までに貸借を合わせなければ月次報告を出せない'},
  8:{theme:'社長の緊急質問',place:'社長室',requester:'社長',problem:'利益が出ているのに現金が増えない理由を、試算表から説明するよう求められました',goal:'試算表から利益と資金の違いを説明する',result:'社長への回答に使う数値',stakes:'「利益はどこへ消えた？」社長が答えを待っている'},
  9:{theme:'決算前夜',place:'決算前夜の経理室',requester:'水野先輩',problem:'当期に含めるべき収益と費用の確認が残っています',goal:'決算整理の未処理を解消する',result:'当期に帰属する収益・費用',stakes:'翌朝までに、期間をまたぐ数字を正さなければならない'},
  10:{theme:'年度決算',place:'年度決算の作業室',requester:'経理責任者',problem:'精算表の空欄が残り、一年間の利益をまだ確定できません',goal:'精算表を完成して一年間の成果を確定する',result:'当期純利益と期末残高',stakes:'利益の一行が、会社の次年度を左右する'},
  11:{theme:'取締役会報告',place:'取締役会前の会議室',requester:'社長',problem:'役員へ提出する財務諸表について、各数値の根拠を確認する必要があります',goal:'財務諸表の数値を帳簿から説明できるようにする',result:'財務諸表の根拠となる数値',stakes:'役員の追及に、推測ではなく数字で答える'},
  12:{theme:'最後の決算',place:'取締役会当日の経理室',requester:'水野先輩',problem:'一年分の記録をまとめた最終報告書に、確認待ちの項目が残っています',goal:'一年分の記録を最終報告書にまとめる',result:'会社の成果と財政状態',stakes:'この報告が、会社とあなたの次の一年を決める'}
});
...
const ReaderFacingBeats = Object.freeze([
  ...
  (arc, item, instruction) => `${arc.place}。あなたは${arc.requester}へ${item.workResult}を報告するため、資料を確認します。${instruction}。`,
...
const ledgerPurpose = category => {
  ...
  if (/商品有高帳/u.test(category)) return '商品の入出庫を数量・単価・残高で管理する補助簿';
  if (/仕訳帳/u.test(category)) return '取引を発生順に借方と貸方へ記録する主要簿';
  if (/伝票/u.test(category)) return '入金・出金・振替の証拠を取引別に残す記録';
  if (/補助|買掛|売掛/u.test(category)) return `${category}の相手先別の増減と残高を確かめる補助簿`;
  return '指定勘定の増減と残高を追う帳簿';
};
const methodFor = item => ({
  journal:`${item.category}では増減を分け、資産・費用の増加は借方、負債・純資産・収益の増加は貸方に置きます`,
  ledger:`${item.category}は${ledgerPurpose(item.category)}なので、日付・摘要・残高を資料と結びます`,
  trial_balance:`${item.category}では各残高を借方か貸方へ集め、両欄の合計一致を確かめます`,
  correction:`${item.category}では誤記を取り消す向きと、本来記録すべき向きを分け、その差額だけを訂正します`,
  worksheet:`${item.category}では決算整理を反映後、損益計算書欄と貸借対照表欄へ振り分けます`,
  financial_statement:`${item.category}では期間の収益・費用と期末の資産・負債・純資産を混同せず、対応する表示欄へ集計します`,
