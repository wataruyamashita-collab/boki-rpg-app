...
assert(localAssets.length > 0 && localAssets.every(([, , query]) => query === '?v=20260822-1'), 'すべてのローカルCSS/JSに最新のキャッシュバスターを付ける');
...
assert(html.includes('css/style.css?v=20260822-1') && html.includes('js/view.js?v=20260822-1'), 'iPhone Chromeに改修後のCSSとJSを再読み込みさせる');
