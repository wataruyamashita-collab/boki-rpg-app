...
(async () => {
  ...
  assert.strictEqual(currentKey, 'boki-rpg-20260824-11');
  const current = stores.get(currentKey);
  assert(current.added.includes('./data/questions.js?v=20260824-11') && current.added.includes('./js/feedback.js?v=20260824-11') && current.added.includes('./js/controller.js?v=20260824-11'), 'coherent version assets are installed');
