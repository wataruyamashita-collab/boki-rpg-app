(function (root) {
  ...
  const ACCOUNT_TYPES = {
    asset: new Set(['現金','普通預金','当座預金','売掛金','繰越商品','備品','電子記録債権','クレジット売掛金','前払金','現金過不足','小口現金','仮払金','立替金','仮払消費税','前払保険料','受取商品券','差入保証金','未収利息','貯蔵品','貸付金']),
    contraAsset: new Set(['貸倒引当金','減価償却累計額','備品減価償却累計額']),
    liability: new Set(['買掛金','借入金','電子記録債務','未払金','前受金','所得税預り金','社会保険料預り金','仮受消費税','仮受金','前受家賃','未払利息','未払法人税等','未払消費税']),
