...
assert(runner.includes("wrapper.scrollLeft = maximumScrollLeft") && runner.includes("selectedContextText:contexts[0]?.textContent || ''") && runner.includes("guidanceVisibleAtRight:intersectsViewport(guidance)"), 'journal-book visual evidence exercises the right edge, account-context update, and sticky guidance');
