...
const questionRecords=contracts.questionReview(production.questions);
const evaluated=contracts.executeContracts(auditResult,mutationResults,answerCorruptionResults,before,production,questionRecords);
...
const coverage=evaluated.coverage;
