...
const directAudit=contracts.directAuditEvidence(questionRecords,coverage);
const evaluated=contracts.executeContracts(auditResult,mutationResults,answerCorruptionResults,before,production,questionRecords,coverage);
